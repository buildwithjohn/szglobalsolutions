...
export default function OurApproachPage() {
  return (
    <>
      ...
      <section className="section">
        <div className="container-x">
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {steps.map((s) => (
              <div key={s.n} data-reveal className="card overflow-hidden p-0">
      ...
      <section className="section">
        <div className="container-x">
          <div data-reveal className="relative overflow-hidden rounded-2xl border border-white/10">
            ...
            <div className="relative max-w-xl p-10 sm:p-14">
              ...
              <h2 className="mt-6 font-display text-2xl font-bold leading-tight tracking-wide text-white sm:text-3xl">
