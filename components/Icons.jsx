...
export const Knight = (p) => (
  <svg {...base} {...p}>
    <path d="M7 21h10" />
    <path d="M9.5 21c0-2.6.5-4.4 2.4-5.7-1.9 0-3.3-1-3.7-3l1.7 1 1.1-2.5c.9 1.1 2.3 1 3-.2.8-1.6 2.3-2.6 3.9-2 2.2.7 3.2 3.2 3.2 6.8 0 3-.2 4.7-.2 5.6" />
  </svg>
);
